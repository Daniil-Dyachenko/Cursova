    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='Опрацювується', max_length=50, verbose_name='Статус замовлення')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customs.custom', verbose_name='Замовлення')),
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='sushi.products', verbose_name='Продукт')),
            ],
            options={
